...
* Made compatibility changes in extension to handle ANSI escape sequences coming from colored text outputs from asist cli.

### Changed

* Converted the InvalidRuleId error into warning, now the execution will continue even if an invalid rule id is encountered.
